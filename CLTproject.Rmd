...
While analyzing I see that both sides are not not the same.The mean is 52.034.
```{r}
numb=2
...
After view i found the mean is 49.529 the sd is 29.7446281183998
...
A way to see that this graph is uneven is that 0.015 and 0.020 shows the difference. The sd is 14.1470640050568" and the mean is 49.9806666666667
...
In this assignment we can see how the central limit theorem was used. We were able to use the sd and mean given to get our conclusions. 
